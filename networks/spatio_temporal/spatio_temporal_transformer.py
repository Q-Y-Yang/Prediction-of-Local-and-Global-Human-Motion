...
from networks.layers import PoseEncoder, PoseDecoder

from networks.spatio_temporal.encoder import SpatioTemporalEncoderBlock
from networks.spatio_temporal.decoder import SpatioTemporalDecoderBlock
...
class SpatioTemporalTransformer(torch.nn.Module):
    ...
    def forward(
        ...
        # backproject joint embeddings to original feature space
        # [BATCH, TIMESTEP, JOINT_IDX, EMBEDDING_DIM]
        # -> [BATCH, TIMESTEP, JOINT_IDX, FEATURES]
